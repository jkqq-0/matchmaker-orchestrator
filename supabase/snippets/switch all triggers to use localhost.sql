...
FOR EACH ROW EXECUTE FUNCTION public.notify_orchestrator_secure('http://host.docker.internal:3000/ingest/projects');
...
FOR EACH ROW EXECUTE FUNCTION public.notify_orchestrator_secure('http://host.docker.internal:3000/ingest/interns/individual');
...
FOR EACH ROW EXECUTE FUNCTION public.notify_orchestrator_secure('http://host.docker.internal:3000/ingest/interns/batch');
